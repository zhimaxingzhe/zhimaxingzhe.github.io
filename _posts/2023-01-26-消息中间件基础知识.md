...
## 订阅模型
![消息模型-发布订阅](/image/mq/消息模型-发布订阅.jpg)
...
![消息协议](/image/mq/消息协议.png)
常见的消息协议：  
![消息协议-目录](/image/mq/消息协议-目录.png)
...
生产消息
![AMQP-生产消息](/image/mq/AMQP-生产消息.png)
消费消息
![AMQP-消费消息](/image/mq/AMQP-消费消息.png)
...
![AMQP-消费消息](/image/mq/Kafka消息协议.jpg)

再展开看Message的定义：
![AMQP-消费消息](/image/mq/Kafka通讯协议.jpg)
...
![RabbitMQ简单模式](/image/mq/RabbitMQ简单模式.png)
<center>简单模式</center>  

![RabbitMQ简单模式](/image/mq/RabbitMQ队列模式.png)
<center>队列模式</center> 

![RabbitMQ发布订阅模式](/image/mq/RabbitMQ发布订阅模式.png)
<center>发布订阅模式</center> 

![RabbitMQ路由模式](/image/mq/RabbitMQ路由模式.png)
<center>路由模式</center> 

![RabbitMQ主题模式](/image/mq/RabbitMQ主题模式.png)
<center>主题模式</center> 

![RabbitMQ RPC模式](/image/mq/RabbitMQ-RPC模式.png)
<center>RPC模式</center> 
...
![RabbitMQ架构](/image/mq/RabbitMQ架构.png)

上图是单机的架构，那么集群架构是怎么样的呢？

![RabbitMQ高可用架构](/image/mq/RabbitMQ高可用.png)
...
# RocketMQ
## 基础概念
![RocketMQ基础概念](/image/mq/RocketMQ基础概念.png)
### Tag
...
![RocketMQ架构](/image/mq/RocketMQ架构.png)
...
![RocketMQ高可用](/image/mq/RocketMQ高可用.png)
...
![RocketMQ事务消息](/image/mq/RocketMQ事务消息.png)
...
事务消息生命周期
![RocketMQ事务消息生命周期](/image/mq/RocketMQ事务消息生命周期.png)
...
![RocketMQ新发展](/image/mq/RocketMQ新发展.png)
...
![Kafka 存储](/image/mq/Kafka存储3.png)
...
# Pulsar
![Pulsar 特点](/image/mq/Pulsar特点.png)
...
下图展示了一个 Pulsar 集群：
![Pulsar 架构](/image/mq/Pulsar架构.png)

![Pulsar 架构](/image/mq/Pulsar架构2.png)
...
![Pulsar 架构](/image/mq/Pulsar分层和分片.png)
...
![Pulsar 架构](/image/mq/Pulsar分层和分片2.png)
...
常言道，最好的学习方法是带着问题去寻找答案，在路上捡拾更多果实，增加经验值，快速升级。也很多人推荐费曼学习法，以教代学，按可以教别人的标准来学习，最终产出教学内容为目的来学习一个知识，能让自己高效学习。在我看来这很像绩效考核用的OKR工具，为项目设定关键成果，实现成功应该做什么？怎么做？而我写这篇文章是在实践费曼学习法。  
...
如果自己平时想到的问题太多，不知道先看哪一个，那么自己想清楚为什么要学这些知识点，那个问题对于当前的自己收益最大。
...
声明：文中许多图片来源于网络，仅用于学习记录，仅摘抄之用，侵删。
